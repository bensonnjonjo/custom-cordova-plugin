...
Custom.prototype = {
    ...
    isServiceAvailable: function (callback, scope) {
        ...
        cordova.exec(callbackFn, null, 'Custom', 'isServiceAvailable', []);
    },

    /**
     * Sends the content to a Custom app or service.
     *
    ...
    isconnected: function(successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, 'Custom', 'isconnected', []);
    }
};
